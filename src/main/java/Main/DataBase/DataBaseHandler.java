...
import Main.Common.CertInfoDAO;
...
public class DataBaseHandler {
    ...
    public static void connect() throws Exception {
        ...
        connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/uzicrm?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false&useUnicode=yes&characterEncoding=UTF-8", "root", "123456");
        ...
        try {
            ...
            if (rs.next()) {
                do {
                    ...
                    CertInfoDAO.addCert(new CertInfo(
    ...
    public static void saveCert(CertInfo certInfo){
        try {
            ...
            ps.setBytes(5, CertInfoDAO.getSignCertinfo(certInfo));
            ps.executeUpdate();
        } catch (SQLException e) {
            e.printStackTrace();
        }
